...
// Undefine this if you don't want digital pin 7
// used for reset (this would only be the case if
// you're using version 2 of the Circuits@Home shield
// *and* you want to use digital pin 7 for something):
#define USE_V1_COMPATIBLE_RESET
...
/* Assume a Arduino Mega ADK board with MAX3421e built-in */
