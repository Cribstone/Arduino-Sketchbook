1.Copy the contents \libraries to arduio\libraries folder
2.The DataloggerSketches folder can be placed anywhere
3.Install Fat16 library before using the examples
