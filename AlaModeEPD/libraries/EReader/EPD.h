...
public:
	...
	void image(const prog_uint8_t *image PROGMEM) {
	...
	void image(const prog_uint8_t *old_image PROGMEM,  const prog_uint8_t *new_image PROGMEM) {
	...
	void frame_data(const prog_uint8_t *new_image PROGMEM, EPD_stage stage);
	...
	void frame_data_repeat(const prog_uint8_t *new_image PROGMEM, EPD_stage stage);
