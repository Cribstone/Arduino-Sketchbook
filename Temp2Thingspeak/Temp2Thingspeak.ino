/*
  ...
  This sketch updates a channel feed with an analog input reading via the ThingSpeak API 
  (http://community.thingspeak.com/documentation/) using HTTP POST.
...
byte mac[] = { 0x90, 0xA2, 0xDA, 0x00, 0xCF, 0x4F }; // Must be unique on local network


// ThingSpeak Settings
char thingSpeakAddress[] = "api.thingspeak.com";
String writeAPIKey = "YWFFVMAMDOU8IX0J";
...
void loop(void)
{
  ...
  {
    updateThingSpeak("field1="+String(DEC)+"&field2="+String(DEC));
  }
