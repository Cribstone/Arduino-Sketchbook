...
Servo TKServo;  // create servo object to control a servo 
...
void setup() 
{
  TKServo.attach(5);  // attaches the servo on pin 9 to the servo object  
}
...
void loop() 
{
  ...
  {                                              // decreasing the value by 1 each loop 
    TKServo.write(pos);        // tell servo to go to position in variable 'pos' 
