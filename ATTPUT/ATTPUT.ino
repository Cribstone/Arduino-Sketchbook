...
// ***** CONSTANTS *****
// ***** GPRS PARAMATERS *****
const  char  apn[] = "wap.cingular";
const  char  username[] = " ";
const  char  password[] = " ";
// ***** COSM PARAMATERS *****
const  char server[] = "api.cosm.com";
const  char path[] = "/v2/feeds/84176.csv";	
const  char port[] = "80";
const  char host[] = "api.cosm.com";
const  char controlKey[] = "X-PachubeApiKey:  zjuYgn3Ps8mn8DtXY3tzu1e3CkySAKxqL0tPVytVZ3NRcz0g";
const  char contentType[] = "text/csv";
const  char stream[] = "MicroTracker";
